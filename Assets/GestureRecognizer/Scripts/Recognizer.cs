...
namespace GestureRecognizer
{
    ...
    public struct Score
    {
        ...
        public float score
        {
            get
            {
                float posScore = Mathf.Clamp01(1f - positionDistance / 60);
                float curvScore = Mathf.Clamp01(1f - curvatureDistance / 60);
                float angleScore = Mathf.Clamp01(1f - angleDistance / 60);
                return Mathf.Clamp01((4 * posScore + 1 * curvScore + 1 * angleScore) / 7);
            }
        }
